...
public class SecondActivity extends AppCompatActivity implements SwipeStack.SwipeStackListener, View.OnClickListener {
...
//            imageViewCard.setImageDrawable(mData.get(position));
